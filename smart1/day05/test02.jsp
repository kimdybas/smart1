<%@page language="java" contentType="text/html; chartset=EUC=KR" pageEncoding+"euc-KR"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>Method 방식 요청</title>
<style type="text/css">
	.content {
		margin: 0px auto;
		width: 60%;
...
<body>
	<div class="content">
		...
		<form method="POST" action="result.html" name="frm" class="fr"></form>
			<div>
